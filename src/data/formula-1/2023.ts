...
const drivers: Entrants = {
  ...
  rus: new Entrant("Russell", "rus", "#00d2be", "#010136"),
  lec: new Entrant("Leclerc", "lec", "#dc0000", "#ffffff"),
  sai: new Entrant("Sainz", "sai", "#dc0000", "#ffffff"),
  ver: new Entrant("Verstappen", "ver", "#00327d", "#ffffff"),
  per: new Entrant("Perez", "per", "#00327d", "#ffffff"),
  str: new Entrant("Stroll", "str", "#1B8E2D", "#ffffff"),
  alo: new Entrant("Alonso", "alo", "#1B8E2D", "#ffffff"),
  gas: new Entrant("Gasly", "gas", "#fa85b9", "#010136"),
  oco: new Entrant("Ocon", "oco", "#fa85b9", "#010136"),
  hul: new Entrant("Hulkenberg", "hul", "#909599", "#010136"),
  mag: new Entrant("Magnussen", "mag", "#909599", "#010136"),
  nor: new Entrant("Norris", "nor", "#ff8700", "#010136"),
  pia: new Entrant("Piastri", "pia", "#ff8700", "#010136"),
  bot: new Entrant("Bottas", "bot", "#800000", "#ffffff"),
  zho: new Entrant("Zhou", "zho", "#800000", "#ffffff"),
  tsu: new Entrant("Tsunoda", "tsu", "#203a54", "#ffffff"),
  dev: new Entrant("de Vries", "dev", "#203a54", "#ffffff"),
  alb: new Entrant("Albon", "alb", "#37BEDD", "#010136"),
  sar: new Entrant("Sargeant", "sar", "#37BEDD", "#010136"),
};

const teams: Entrants = {
  mer: new Entrant("Mercedes", "mer", "#00d2be", "#010136"),
  fer: new Entrant("Ferrari", "fer", "#dc0000", "#ffffff"),
  rbr: new Entrant("Red Bull", "rbr", "#00327d", "#ffffff"),
  mcl: new Entrant("McLaren", "mcl", "#ff8700", "#010136"),
  alp: new Entrant("Alpine", "alp", "#fa85b9", "#010136"),
  alt: new Entrant("Alpha Tauri", "alt", "#203a54", "#ffffff"),
  ast: new Entrant("Aston Martin", "ast", "#1B8E2D", "#ffffff"),
  has: new Entrant("Haas", "has", "#909599", "#010136"),
  alf: new Entrant("Alfa Romeo", "alf", "#800000", "#ffffff"),
  wil: new Entrant("Williams", "wil", "#37BEDD", "#010136"),
};
